...
<div class="text-center p-10">
    <h1 class="font-bold text-black text-4xl mb-4">Chaussures Enfant</h1>
</div>
...
<section id="Projects"
    ...
    <?php 
    include 'confi.php';
    $requete = mysqli_query($con,"SELECT * FROM `tblproduct` where categorie ='enfant' and type ='Chaussures'");
